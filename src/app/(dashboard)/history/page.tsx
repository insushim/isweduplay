      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card className="p-4 bg-gradient-to-br from-blue-600 to-cyan-600 border-none shadow-lg">
            <div className="text-3xl font-bold text-white drop-shadow-md">{totalGames}</div>
            <div className="text-sm text-white/90 font-medium">총 게임</div>
          </Card>
          <Card className="p-4 bg-gradient-to-br from-purple-600 to-pink-600 border-none shadow-lg">
            <div className="text-3xl font-bold text-white drop-shadow-md">{totalScore.toLocaleString()}</div>
            <div className="text-sm text-white/90 font-medium">총 점수</div>
          </Card>
          <Card className="p-4 bg-gradient-to-br from-green-600 to-emerald-600 border-none shadow-lg">
            <div className="text-3xl font-bold text-white drop-shadow-md">{avgAccuracy}%</div>
          ...
          <Card className="p-4 bg-gradient-to-br from-yellow-500 to-amber-500 border-none shadow-lg">
            <div className="text-3xl font-bold text-white drop-shadow-md">{wins}</div>
            <div className="text-sm text-white/90 font-medium">1등 횟수</div>
          </Card>
        </div>
