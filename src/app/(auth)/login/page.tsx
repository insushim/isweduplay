          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                ...
                className="w-full bg-white hover:bg-gray-100 text-gray-800 border-0 py-6"
              >
              ...
              <Button
                ...
                className="w-full bg-[#FEE500] hover:bg-[#FDD800] text-[#3C1E1E] border-0 py-6"
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
              ...
              <Button
                ...
                className="w-full bg-[#03C75A] hover:bg-[#02B150] text-white border-0 py-6"
              >
